  ...
  return (
    <div>
      <div className="flex flex-wrap justify-center items-center py-4">
        <div className="m-2 md:m-8 relative w-16 h-16 md:w-32 md:h-32">
          <Image
            src="/img/profile-icon-circle.png"
            alt="YOS0602 profile image"
            layout="fill"
            objectFit="contain"
          />
        </div>
      ...
      <div className="text-left mx-2 sm:mx-20 xl:mx-52">
        <p>はじめまして！</p>
        <p>
          岐阜出身名古屋在住のエンジニアです。大学では欧米圏の文化を専攻していましたが、もともと興味のあったIT業界に飛び込みました。
        </p>
        <p>
          ユーザ系SIerとしてキャリアをスタートさせました。Express/Nodeを使用したAPI開発、React/Vue.jsを使用したwebページ作成、MicrosoftAzureでのサーバ/ネットワーク設計、プロジェクトの進捗管理等の経験があります。
        </p>
      </div>
    </div>
  )
